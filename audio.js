...
const app = {
    ...
    songs: [
        {
            ...
            singer: 'CHU DUYÊN',
            path: './assets/music/NGỠ NHƯ GIẤC MƠ - CHU DUYÊN.mp3',
            image: './assets/img/ChuDuyen.jpg',
            background: 'https://i.postimg.cc/bvtNbh6P/Clannad.jpg'
        }],
    //     {
    //         name:'Khuê Mộc Lang',
    //         singer:'Changmie Cover',
    //         path:'./assets/music/Khuê Mộc Lang - Changmie Cover.mp3',
    //         image:'./assets/img/Changmie.jpg',
    //         background:'https://i.postimg.cc/Fz40JGNr/Violet.png'
    //     },
    //     {
    //         name:'Ái Nộ + Lạc',
    //         singer:'YLing',
    //         path:'./assets/music/Mashup ÁI NỘ LẠC - MASEW x KHOI VU x RHYMASTIC - YLing Cover.mp3',
    //         image:'./assets/img/YLing.jpg',
    //         background:'https://i.postimg.cc/7ZbLH70f/Date-ALive.jpg'
    //     },
    //     {
    //         name:'Khuê Mộc Lang',
    //         singer:'Út Nhị',
    //         path:'./assets/music/Khuê Mộc Lang - Út Nhị.mp3',
    //         image:'./assets/img/KhueMocLang.jpg',
    //         background:'https://i.postimg.cc/3J8Rqzwj/Oregairu.jpg'
    //     },

    //     {
    //         name:'Tình Thương Phu Thê',
    //         singer:'Út Nhị',
    //         path:'./assets/music/Tình Thương Phu Thê - Cover Út Nhị.mp3',
    //         image:'./assets/img/UtNhi.jpg',
    //         background:'https://i.postimg.cc/RFxCLD8H/ReZero.png'
    //     },
    //     {
    //         name:'Best Piano',
    //         singer:'YIRUMA',
    //         path:'./assets/music/The Best Of YIRUMA Yiruma\'s Greatest Hits - Best Piano.mp3',
    ...
    render: function () {
        ...
        $('#currentSlide').style.backgroundImage = `url('${app.songs[app.currentIndex].background}')`;
    },
    ...
    handleEvents: function () {
        ...
        audio.onloadedmetadata = function () {
            ...
            scrollToActiveSong();
            //Vẫn tự động chuyển slide khi sang bài mới
            slideIndex=0;
            if(isAutoChange){
        ...
        nextBtn.onclick = function () {
            ...
            $('#nextSlide').style.backgroundImage = `url('${app.songs[app.currentIndex].background}')`;
